...
y_score_lr = lr.fit(X_train, y_train).decision_function(X_test) # distance between each data point to the hyperplane
...
# Optimising a classifier using different evaluation metrics
